...
public class ChomskyConverter {
	...
	private void removeLong(Grammar cfg){
		...
		ArrayList<Character> newNonTerminals = new ArrayList<Character>();
		...
		for(State old : cfg.getStates()){
			...
			ArrayList<Character> newNonTermList = new ArrayList<Character>();
			
			//initialize empty set of derivations for the new original derivation
			ArrayList<String> forNewOrig = new ArrayList<String>();
			...
			ArrayList<String> forlengthLess3 = new ArrayList<String>();
			...
			for(String checkLength : old.getDerivations()){
				if(checkLength.length()>2&&!checkLength.contains(" ")){
					...
					ArrayList<String> forFinalNewState = new ArrayList<String>();
		...
		ArrayList<State> finalNewStates = new ArrayList<State>();
	 ...
	 * @param cfg the grammar to be converted
	 * @return the grammar that is now in Chomsky Normal Form
	 */
